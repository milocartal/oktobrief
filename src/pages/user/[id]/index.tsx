...
import { UserWithPromo } from "~/utils/type";
...
const AdminProfileScreen: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = ({ user }) => {
    ...
    return (
        <>
            <Head>
                <title>{user.firstName + " " + user.name}</title>
            ...
            <main className="flex min-h-screen flex-col items-start justify-start bg-[#F3F3F3] px-[10%] pt-[40px] ml-[100px]">
                ...
                <span className="flex w-full flex-row items-center justify-between mb-10">
                    <h1 className="text-4xl font-extrabold text-black">Profil de {user.firstName + " " + user.name}</h1>
                </span>
                ...
                <span className="flex w-full flex-row items-center justify-between mb-10 mt-10">
                    <h1 className="text-4xl font-extrabold text-black">Liste des promos de {user.firstName + " " + user.name}</h1>
                </span>
