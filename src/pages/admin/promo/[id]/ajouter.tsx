  ...
  return (
    <>
      ...
      <main className="bg-[#F3F3F3] h-screen min-w-screen pl-[150px] p-[50px] flex items-center jutisfy-center gap-5">
        ...
        <Link href={"/admin/promo"} className="px-5 py-2 bg-[#0e6073] text-white rounded-lg absolute top-[50px] flex items-center justify-between gap-1"><BiLeftArrowAlt className="text-3xl" /> Retour</Link>
