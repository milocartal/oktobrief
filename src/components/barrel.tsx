    ...
    return (
        <div className="fixed top-0 left-0 w-[100px] bg-gradient-to-tr from-[#0e6073] to-[#33a5a6] h-screen flex flex-col items-center text-white text-sm justify-between pt-5 pb-8 px-2">
            ...
            <div className="flex flex-col items-center rounded-lg justify-start gap-[3px]">
                ...
                {(sessionData?.formateur || sessionData?.user.superadmin) && <Link href={`/admin/suivis/1`} className="flex flex-col items-center rounded-lg justify-center rounded-lg transition px-2 hover:bg-[#2EA3A5] w-full py-3 text-center rounded-lg"><BiListCheck className="text-2xl mb-1" />Suivi</Link>}
