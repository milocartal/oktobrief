...
export const briefRouter = createTRPCRouter({
    ...
    create: protectedProcedure.input(z.object({ title: z.string(), desc: z.string(), idRef: z.string(), contexte: z.string(), peda: z.string(), eval: z.string(), livrable: z.string(), perf: z.string() })).mutation(({ input }) => {
